package com.mayo.bluetoothle.protocol;
...
public class RBLProtocol {
	...
	final String TAG = "RedBear Protocol";
...
/*	public void setRedBearService(RedBearService mRedBearService) {
	...
	public void parseData(int[] data) {
		...
		while (i < length) {
			int type = data[i++];
			Log.i(TAG, "type: " + Character.toChars(type)[0] );
			switch (type) {
	...
	protected void write(char[] data) {
        mIrblProtocol.writeValue(address,data);

	}

	public void setPinMode(int pin, int mode) {
		Log.i(TAG, "RBLPRotocol: setPinMode");
	...
	public void digitalRead(int pin) {
		Log.i(TAG, "RBLProtocol: digitalRead");
	...
	public void digitalWrite(int pin, int value) {
		Log.i(TAG, "RBLProtocol: digitalWrite");
	...
	public void queryPinAll() {
		Log.i(TAG, "RBLProtocol: queryPinAll");
	...
	public void queryProtocolVersion() {
		Log.i(TAG, "RBLProtocol: queryProtocolVersion");
	...
	public void queryTotalPinCount() {
		Log.i(TAG, "RBLProtocol: queryTotalPinCount");
		char buf[] = { 'C' };
		write(buf);
		// wirte value
	}
	...
	public void queryPinCapability(int pin) {
		Log.i(TAG, "RBLProtocol: queryPinCapability");
		char buf[] = { 'P', (char) pin };
		write(buf);
	...
	public void queryPinMode(int pin) {
		Log.i(TAG, "RBLPRotocol: queryPinMode");
		char buf[] = { 'M', (char) pin };
		write(buf);
		// wirte value
	}
	...
	public void analogWrite(int pin, int value) {
		Log.i(TAG, "RBLPRotocol: analogWrite value: " + value);
	...
	public void servoWrite(int pin, int value) {
		Log.i(TAG, "RBLPRotocol: servoWrite value: " + value);
